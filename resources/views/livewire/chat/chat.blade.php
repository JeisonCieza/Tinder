<div class="flex h-screen overflow-hidden">
    <main class="w-full grow border flex flex-col relative">
        <!-- header -->
        <header class="flex items-center gap-2.5 p-5 border">
            <!-- return button -->
            <a href="{{route('chat.index')}}" class="sm:hidden" wire:navigate>
                <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-left w-6 h-6" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0" />
                    </svg>
                </span>
            </a>

            <x-avatar class="w-10 h-w-10" />
            ...
            <div class="ml-auto flex items-center gap-2 px-2">
                ...
                <!-- Dots -->
                <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-three-dots text-gray-500 w-7 h-7" viewBox="0 0 16 16">
                ...
                <a href="{{route('app')}}">
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-octagon-fill text-gray-500 w-7 h-7" viewBox="0 0 16 16">
        ...
        <!-- body -->
        <section class="flex flex-col gap-5 overflow-auto h-full p-2.5 overflow-y-auto flex-grow overflow-x-hidden w-full my-auto custom-scrollbar-chat">
            @for ($i = 0; $i <12; $i++)
                @php
                ...
                <div @class([ 'max-w-[85%] md:max-w-[78%] flex w-auto gap-2 relative mt-2' , 'ml-auto'=>$belongsToAuth
                    ...
                    <div @class(['shrink-0 mt-auto','invisible'=>$belongsToAuth])>
                        <x-avatar class="w-7 h-7" src="https://randomuser.me/api/portraits/women/17.jpg" />
                    </div>

                    <!-- Message body -->
                    <div @class(['flex flex-wrap text-[15px] border border-gray-200/40 rounded-xl p-2.5 flex flex-col text-black bg-[#f6f66f8fb]', 'bg-blue-500 text-white'=>$belongsToAuth
                        ])>

                        <p class="whitespace-normal text-sm md:text-base tracking-wide lg:tracking-normal">
                            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Alias asperiores deleniti, exercitationem neque ipsam optio temporibus ut voluptate nihil ipsum tempore amet, ipsa assumenda in cumque nam repellat! Possimus, dignissimos.
                        </p>
                    </div>
                </div>
        ...
        <footer class="sticky bottom py-2 inset-x-0 p-2">
            <form action="" x-data="{body:@entangle('body')}" autocomplete="off">
                ...
                <div class="grid grid-cols-12 items-center">
                    ...
                    <input x-model="body" type="text" autocomplete="off" autofocus placeholder="Escribe tu mensaje aquí" maxlength="1700"
                        class="col-span-9 bg-gray-100 border-0 outline-0 focus:border-0 focus:ring-0 hover:ring-0 rounded-lg focus:outline-none">

                    <button x-bind:disabled="!body.trim()" type="submit" class="col-span-2 hover:inset-10 hover:bg-green-400">
                        <span class="flex p-2 items-center justify-center">
                            Enviar
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-send translate-x-2 translate-y-[2px]" viewBox="0 0 16 16">
    ...
    <aside class="w-[48%] hidden sm:flex border">
        <div
            ...
            class="inset-0 overflow-y-auto overflow-hidden overscroll-contain border rounded-xl w-full bg-white space-y-4 custom-scrollbar-chat">
            ...
            <section class="grid gap-4 p-3">
                ...
                <div class="rounded-xl bg-green-200 h-24 px-4 py-2 max-w-fit flex gap-4 items-center">
                    ...
                    <div class="grid w-4/5">
                        ...
                        <span class="font-lg text-green-800 capitalize"> {{str_replace('_',' ',$receiver->relationship_goals?->value)}} </span>
                    </div>
                </div>
