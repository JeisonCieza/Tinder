...
<body
    style="background-image:  url(' {{ asset('assets/tinder.webp')}} '); background-size:cover; background-attachment: fixed"
    class="antialiased">
    <div class=" bg-black/30 bg-black">
        <header class=" relative min-h-screen bg-black/40 flex flex-col">
            @if (Route::has('login'))
